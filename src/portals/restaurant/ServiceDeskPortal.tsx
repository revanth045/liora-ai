...
//  Sound helper ‚ î Web Audio API beep
// ‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä
function beep() {
  try {
    ...
    // browser may block autoplay ‚ î ignore silently
  }
}
            ...
            {order.items.map((item, idx) => (
              <li key={idx} className="flex items-center justify-between text-sm">
                <span className="text-stone-300">
                  <span className="font-bold text-white">{item.qty}√ó</span> {item.name}
                </span>
          ...
          {order.status !== 'delivered' && order.status !== 'rejected' && (
            <div className="flex gap-2 pt-1">
              {nextStatus && (
                ...
                >
                  {nextStatus === 'preparing' ? '‚ ì Accept ‚ î Start Preparing'
                    : nextStatus === 'ready' ? '‚ ì Mark as Ready'
                    : nextStatus === 'delivered' ? '‚ ì Mark Delivered'
                    : `‚ í ${STATUS_LABELS[nextStatus]}`}
                </button>
              )}
              {order.status === 'pending' && (
                <button
