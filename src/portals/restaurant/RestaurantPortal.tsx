                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        <span className={`flex-shrink-0 transition-colors ${isActive ? 'text-white' : 'text-stone-400 group-hover:text-stone-600'}`}>
                          <Icon name={item.icon} size={18} />
                        </span>
                        <span className="truncate">{item.label}</span>
                      </div>
                      {item.isNew && (
                        <span className={`flex-shrink-0 text-[8px] font-bold px-1.5 py-0.5 rounded-full ml-1 ${
