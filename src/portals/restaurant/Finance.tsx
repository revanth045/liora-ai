            ...
            {[
              ...
              <div key={i} className="group">
                <div className="flex justify-between items-end text-sm mb-2">
                  ...
                  <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">{item.amt} <span className="opacity-50">Ã¢â ¬Â¢ {item.val}</span></span>
                </div>
              ...
              <div key={i} className="p-5 flex justify-between items-center hover:bg-cream-50/30 transition-colors">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] font-bold text-stone-400 uppercase tracking-wider">{tx.date} Ã¢â ¬Â¢ {tx.bank}</p>
                  </div>
                </div>
