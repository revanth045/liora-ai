...
// ‚ Ä‚ Ä‚ Ä Coupon copy button ‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä
...
// ‚ Ä‚ Ä‚ Ä Restaurant Offer Card ‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä
    ...
    <div className="bg-white border border-cream-200 rounded-3xl shadow-sm overflow-hidden">
      ...
      <div className="px-6 py-5 space-y-3">
        ...
        {promo.code ? (
          ...
          <p className="text-[11px] text-stone-400 italic">No code needed ‚ î discount applied automatically at {restaurantName}.</p>
        )}
...
// ‚ Ä‚ Ä‚ Ä Liora Offer Card (platform-wide) ‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä
    ...
    <div className="bg-white border border-cream-200 rounded-3xl shadow-sm overflow-hidden">
      ...
      <div className="px-6 py-5 space-y-3">
        <p className="text-stone-600 text-sm leading-relaxed">
          You completed your profile and we noticed. Here's $5 off your next order ‚ î valid at any restaurant on Liora. No rush, no deadline.
        </p>
        <div className="flex items-center gap-2">
          <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Valid at</span>
  ...
  return (
    <div className="h-full overflow-y-auto scrollbar-hide">
      <div className="max-w-md mx-auto px-4 py-8 space-y-10">
        ...
        {/* ‚ Ä‚ Ä Restaurant Offers ‚ Ä‚ Ä */}
        <section>
          <div className="mb-4">
            <h2 className="font-lora text-xl font-bold text-stone-800">Restaurant Offers</h2>
            <p className="text-xs text-stone-400 mt-1">Deals from the restaurants you love ‚ î use the code when ordering from that specific spot.</p>
          </div>

          {restaurantPromos.length === 0 ? (
            <div className="bg-white border border-cream-200 rounded-3xl px-6 py-10 text-center">
              <p className="text-3xl mb-3">  ΩÔ∏è</p>
              <p className="font-semibold text-stone-600 text-sm">No restaurant offers right now</p>
              <p className="text-stone-400 text-xs mt-1">Check back soon ‚ î restaurants update their deals regularly.</p>
            </div>
          ) : (
        ...
        {/* ‚ Ä‚ Ä Liora Offers ‚ Ä‚ Ä */}
        <section>
          <div className="mb-4">
            <h2 className="font-lora text-xl font-bold text-stone-800">Liora Offers</h2>
            <p className="text-xs text-stone-400 mt-1">Platform-wide perks from Liora ‚ î these work at every restaurant we partner with.</p>
          </div>
          <LioraOfferCard />
        </section>
