...
// ‚ Ä‚ Ä‚ Ä Status config (dine-in flow only) ‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä
...
// ‚ Ä‚ Ä‚ Ä Order Card ‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä‚ Ä
      ...
      <button onClick={onToggle}
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-stone-400 truncate">
            {order.items.map(i => `${i.qty}√ó ${i.name}`).join(', ')}
          </p>
          {order.tableNumber && (
              ...
              {order.items.map((item, i) => (
                <div key={i} className="flex justify-between items-center py-2 border-b border-cream-100 last:border-0">
                  <div className="flex items-center gap-2">
                    <span className="w-5 h-5 bg-stone-100 rounded text-[10px] font-bold text-stone-500 flex items-center justify-center">{item.qty}√ó</span>
