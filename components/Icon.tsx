...
export const Icon: React.FC<IconProps> = ({ name, className, size = 24 }) => {
  const icons: { [key: string]: React.JSX.Element } = {
    ...
    hotel: (
        <>
          <path strokeLinecap="round" strokeLinejoin="round" d="M3 21V5a2 2 0 012-2h6a2 2 0 012 2v16" />
          <path strokeLinecap="round" strokeLinejoin="round" d="M13 9h6a2 2 0 012 2v10" />
          <path strokeLinecap="round" strokeLinejoin="round" d="M2 21h20" />
          <path strokeLinecap="round" strokeLinejoin="round" d="M6 7h2M6 11h2M6 15h2M16 13h2M16 17h2" />
          <path strokeLinecap="round" strokeLinejoin="round" d="M7 21v-3h2v3" />
        </>
    ),
    concierge_bell: (
        <>
          <path strokeLinecap="round" strokeLinejoin="round" d="M4 17h16a8 8 0 10-16 0z" />
    ...
    chef_hat: (
        <>
          <path strokeLinecap="round" strokeLinejoin="round" d="M6 14a4 4 0 01-1-7.87 5 5 0 019.9-1A4 4 0 0118 14" />
          <path strokeLinecap="round" strokeLinejoin="round" d="M6 14h12v5a2 2 0 01-2 2H8a2 2 0 01-2-2v-5z" />
          <path strokeLinecap="round" strokeLinejoin="round" d="M10 18v-2M14 18v-2" />
        </>
    ),
    sparkle_chat: (
        <>
          <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a8 8 0 11-3.5-6.6" />
          <path strokeLinecap="round" strokeLinejoin="round" d="M21 20l-2.5-2.5M3 21l2.4-1.6A8 8 0 0121 12" />
          <path strokeLinecap="round" strokeLinejoin="round" d="M19 3v4M17 5h4" />
        </>
    ),
    wellness_leaf: (
        <>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 22c-4-2-7-6-7-11a7 7 0 0114 0c0 5-3 9-7 11z" />
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 22V8M12 12c-2-1-3-3-3-5M12 12c2-1 3-3 3-5" />
        </>
    ),
    deal_tag: (
        <>
          <path strokeLinecap="round" strokeLinejoin="round" d="M3 13l8 8a2 2 0 002.8 0l7.2-7.2a2 2 0 00.6-1.4V4a1 1 0 00-1-1h-8a2 2 0 00-1.4.6L3 10.8a2 2 0 000 2.8z" />
